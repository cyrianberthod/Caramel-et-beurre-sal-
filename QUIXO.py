...
L_prof_4=[200] #bcp plus de 200s en réalité, l'ordi ne s'arrête pas de tourner jusqu'à planter.
...
def affichage_temps_prof_avec_sans_elagage():
    ...
    mp.plot(X,Y1,"x")
    mp.plot(X,Y2,"x")
    mp.xlabel("profondeur de calcul")
    mp.ylabel("temps que met l'IA pour jouer (s)")
    mp.legend()
    mp.show()

#affichage_temps_prof_avec_sans_elagage()
